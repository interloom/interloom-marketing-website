...
<iframe src="{{ '/images/landscape-sculpted-93661-512-interactive.html?zoom=15' | url }}" loading="lazy" class="w-full mt-12 border-0" style="height:600px; margin-inline: calc(-1 * var(--_section-px)); width: calc(100% + 2 * var(--_section-px));" aria-hidden="true"></iframe>
