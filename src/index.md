...
<section id="hero" class="relative min-h-[40vh] flex flex-col justify-center pt-24 md:pt-32">
...
<a href="{{ '/video/' | url }}" class="announcement-pill announcement-pill--inverted no-underline" style="width:50%; max-width:400px">
...
<p class="text-base md:text-lg text-fg-3 leading-snug tracking-tight max-w-3xl mt-4" data-scramble="150"><span class="text-fg-2">Deploy production workflows in natural language.</span> Designed for the people who know the domain best, powered by a context graph that constantly gets smarter.</p>
...
<div class="carousel mt-12" role="region" aria-label="Feature slides">
